...
%OBJECTIVE
	\vspace{-3mm}
 \begin{flushleft}
 	\begin{Large}\textbf{Objective:}\end{Large} \hspace{0.05in} To work in a challenging environment using all my skills\hspace{1.75in} and efforts to explore in Embedded field.\\
